...
class MultiRayParticle implements Particle {
  final List<Ray> _rays;
  Point _pos;

  MultiRayParticle(Point pos, this._rays) : _pos = pos;

  factory MultiRayParticle.fromPosition(Point position) {
    List<Ray> result = [];
    ...
    return MultiRayParticle(position, result);
  }
